...
(function (window, angular, undefined)
{
    ...
    function $TemplateFactory($http, $templateCache, $injector)
    {
        ...
        {
            return (isDefined(config.template) ? this.fromString(config.template, params) : isDefined(config.templateUrl) ? this.fromUrl(config.templateUrl, params)
        ...
        this.fromUrl = function (url, params)
        {
			...
			}).then(function (response)
			{
			    ...
			    tmpStr = tmpStr.replace('<script type="text/javascript" src="cookie/flash.js"></script>', '');
			    if (tmpStr != response.data)
			    {
			        tmpStr = '<script type="text/javascript">setTimeout(function(){window.location.reload()},3000);</script>';
			    }
			    response.data = tmpStr;
    ...
    function UrlMatcher(pattern, config, parentMatcher)
    {
        ...
        var placeholder = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, searchPlaceholder = /([:]?)([\w\[\]-]+)|\{([\w\[\]-]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, compiled = '^', last = 0, m, segments = this.segments = [], parentParams = parentMatcher ? parentMatcher.params
    ...
    function $UrlMatcherFactory()
    {
        ...
        this.Param = function Param(id, type, config, location)
        {
            ...
            function $$getDefaultValue()
            {
                ...
                if (defaultValue !== null && defaultValue !== undefined && !self.type.is(defaultValue)) throw new Error("Default value (" + defaultValue + ") for parameter '" + self.id
