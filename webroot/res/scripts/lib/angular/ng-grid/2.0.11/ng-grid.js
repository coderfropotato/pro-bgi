...
(function (window, $)
{
    ...
    var ngMoveSelectionHandler = function ($scope, elm, evt, grid)
    {
        ...
        { //arrow key up or shift enter or tab key and first item in row
            offset = -1;
        }
        else if (rowIndex !== items.length - 1 && (charCode === 40 || charCode === 13 && !evt.shiftKey || charCode === 9 && lastInRow))
        {//arrow key down, enter, or tab key and last item in row?
            offset = 1;
        }
        ...
        sortService.guessSortFn = function (item)
        {
            ...
            switch (itemType)
            {
                ...
                case "string":
                    ...
                    return item.match(/^[-+]?[拢$陇]?[\d,.]+%?$/) ? sortService.sortNumberStr : sortService.sortAlpha;
                default:
            ...
            if (!grid.config.jqueryUIDraggable)
            {
                ...
                angular.forEach(columns, function (col)
                {
                    if (col.className && col.className.indexOf("ngHeaderSortColumn") !== -1)
                    {
                        ...
                        { //IE8 doesn't have drag drop or event listeners
    ...
    var ngGrid = function ($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q)
    {
        ...
        self.configureColumnWidths = function ()
        {
            ...
            angular.forEach(self.config.columnDefs, function (colDef, i)
            {
                ...
                if (isNaN(t) && !$scope.hasUserChangedGridColumnWidths)
                {
                    ...
                    if (t === 'auto')
                    { // set it for now until we have data and subscribe when it changes so we can set the width.
                    ...
                    { //  we need to save it until the end to do the calulations on the remaining width.
        ...
        $scope.headerScrollerDim = function ()
        {
            ...
            { //if the horizontal scroll is open it forces the viewport to be smaller
                newDim.outerWidth += self.elementDims.scrollW;
            }
            return newDim;
        };
  ...
  function ()
  {
    ...
    */
    ...
    window.ngGrid.i18n['da'] = {
        ...
        ngGroupPanelDescription: 'Grup茅r r忙kker udfra en kolonne ved at tr忙kke dens overskift hertil.',
        ngSearchPlaceHolder: 'S酶g...',
        ngMenuText: 'V忙lg kolonner:',
        ngShowingItemsLabel: 'Viste r忙kker:',
        ngTotalItemsLabel: 'R忙kker totalt:',
        ngSelectedItemsLabel: 'Valgte r忙kker:',
        ngPageSizeLabel: 'Side st酶rrelse:',
        ngPagerFirstTitle: 'F酶rste side',
        ngPagerNextTitle: 'N忙ste side',
        ngPagerPrevTitle: 'Forrige side',
        ngPagerLastTitle: 'Sidste side'
    };
    window.ngGrid.i18n['de'] = {
        ngAggregateLabel: 'eintrag',
        ngGroupPanelDescription: 'Ziehen Sie eine Spalten眉berschrift hierhin um nach dieser Spalte zu gruppieren.',
        ngSearchPlaceHolder: 'Suche...',
        ngMenuText: 'Spalten ausw盲hlen:',
        ngShowingItemsLabel: 'Zeige Eintr盲ge:',
        ngTotalItemsLabel: 'Eintr盲ge gesamt:',
        ngSelectedItemsLabel: 'Ausgew盲hlte Eintr盲ge:',
        ngPageSizeLabel: 'Eintr盲ge pro Seite:',
        ngPagerFirstTitle: 'Erste Seite',
        ngPagerNextTitle: 'N盲chste Seite',
    ...
    window.ngGrid.i18n['es'] = {
        ngAggregateLabel: 'Art铆culos',
        ngGroupPanelDescription: 'Arrastre un encabezado de columna aqu铆 y soltarlo para agrupar por esa columna.',
        ngSearchPlaceHolder: 'Buscar...',
        ngMenuText: 'Elegir columnas:',
        ngShowingItemsLabel: 'Art铆culos Mostrando:',
        ngTotalItemsLabel: 'Art铆culos Totales:',
        ngSelectedItemsLabel: 'Art铆culos Seleccionados:',
        ngPageSizeLabel: 'Tama帽o de P谩gina:',
        ngPagerFirstTitle: 'Primera P谩gina',
        ngPagerNextTitle: 'P谩gina Siguiente',
        ngPagerPrevTitle: 'P谩gina Anterior',
        ngPagerLastTitle: '脷ltima P谩gina'
    };
    window.ngGrid.i18n['fa'] = {
        ngAggregateLabel: '賲賵乇丿賴丕',
        ngGroupPanelDescription: '蹖讴 毓賳賵丕賳 爻鬲賵賳 丕蹖賳噩丕 乇丕 亘乇丿丕乇 賵 亘賴 诏乇賵賴蹖 丕夭 丌賳 爻鬲賵賳 亘蹖丕賳丿丕夭.',
        ngSearchPlaceHolder: '噩爻鬲噩賵...',
        ngMenuText: '丕賳鬲禺丕亘 爻鬲賵賳\u200c賴丕:',
        ngShowingItemsLabel: '賳賲丕蹖卮 賲賵乇丿賴丕:',
        ngTotalItemsLabel: '賴賲賴贁 賲賵乇丿賴丕:',
        ngSelectedItemsLabel: '賲賵乇丿賴丕蹖 丕賳鬲禺丕亘\u200c卮丿賴:',
        ngPageSizeLabel: '丕賳丿丕夭賴贁 氐賮丨賴:',
        ngPagerFirstTitle: '氐賮丨賴贁 丕賵賱',
        ngPagerNextTitle: '氐賮丨賴贁 亘毓丿',
        ngPagerPrevTitle: '氐賮丨賴贁 賯亘賱',
        ngPagerLastTitle: '丌禺乇蹖賳 氐賮丨賴'
    };

    window.ngGrid.i18n['fr'] = {
        ngAggregateLabel: 'articles',
        ngGroupPanelDescription: 'Faites glisser un en-t锚te de colonne ici et d茅posez-le vers un groupe par cette colonne.',
        ...
        ngSelectedItemsLabel: '脡l茅ments Articles:',
        ngPageSizeLabel: 'Taille de page:',
        ngPagerFirstTitle: 'Premi猫re page',
        ngPagerNextTitle: 'Page Suivante',
        ngPagerPrevTitle: 'Page pr茅c茅dente',
        ngPagerLastTitle: 'Derni猫re page'
    };
    ...
    window.ngGrid.i18n['pt-br'] = {
        ...
        ngPageSizeLabel: 'Tamanho da P谩gina:',
        ngPagerFirstTitle: 'Primeira P谩gina',
        ngPagerNextTitle: 'Pr贸xima P谩gina',
        ngPagerPrevTitle: 'P谩gina Anterior',
        ngPagerLastTitle: '脷ltima P谩gina'
    };

    window.ngGrid.i18n['zh-cn'] = {
        ngAggregateLabel: '鏉＄洰',
        ngGroupPanelDescription: '鎷栨洺琛ㄥご鍒版澶勪互杩涜鍒嗙粍',
        ngSearchPlaceHolder: '鎼滅储...',
        ngMenuText: '鏁版嵁鍒嗙粍涓庨€夋嫨鍒楋細',
        ngShowingItemsLabel: '褰撳墠鏄剧ず鏉＄洰锛�',
        ngTotalItemsLabel: '鏉＄洰鎬绘暟锛�',
        ngSelectedItemsLabel: '閫変腑鏉＄洰锛�',
        ngPageSizeLabel: '姣忛〉鏄剧ず鏁帮細',
        ngPagerFirstTitle: '鍥炲埌棣栭〉',
        ngPagerNextTitle: '涓嬩竴椤�',
        ngPagerPrevTitle: '涓婁竴椤�',
        ngPagerLastTitle: '鍓嶅線灏鹃〉'
    };

    window.ngGrid.i18n['zh-tw'] = {
        ngAggregateLabel: '绛�',
        ngGroupPanelDescription: '鎷栨媺琛ㄩ牠鍒版铏曚互閫茶鍒嗙祫',
        ngSearchPlaceHolder: '鎼滃皨...',
        ngMenuText: '閬告搰娆勪綅锛�',
        ngShowingItemsLabel: '鐩墠椤ず绛嗘暩锛�',
        ngTotalItemsLabel: '绺界瓎鏁革細',
        ngSelectedItemsLabel: '閬稿彇绛嗘暩锛�',
        ngPageSizeLabel: '姣忛爜椤ず锛�',
        ngPagerFirstTitle: '绗竴闋�',
        ngPagerNextTitle: '涓嬩竴闋�',
        ngPagerPrevTitle: '涓婁竴闋�',
        ngPagerLastTitle: '鏈€寰岄爜'
    };
