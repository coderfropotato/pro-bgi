...
define("superApp.managerSuperService", ["super.superMessage", "ngDialog", "ngCookies"],
function (SUPER_CONSOLE_MESSAGE)
{
    //$httpProvider.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded;charset=utf-8';
    var superApp = angular.module("superApp.managerSuperService", ["ngDialog", "ngCookies"]);
    ...
    function AjaxS($log, $http, $q, $window, toolService)
    {
        ...
        this.GetDeferData = function (ajaxConfig)
        {
            ...
            else
            {
                ...
                $http({
                    method: "POST",
                    url: options.api.manager_base_url + "/swap_token",
                    headers: { "Content-Type": "application/json;charset=UTF-8" }
                })
