define([], function() {
    var base_url = "http://report.bgi.com/api/1"; //远程
    var java_url = "http://report.bgi.com/reportweb";
    var staticImg_url = "http://report.bgi.com/"; //静态图片
